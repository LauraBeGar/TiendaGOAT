            ...
            <form name="login" action="/servidor/c_login.php" method="post">
                <div class="row mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" id="email-login" name="email" class="form-control" placeholder="Introduce tu email" required>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="clave-login" name="clave" class="form-control" placeholder="Contraseña" required>
                    </div>
                </div>
                <button type="submit" class="btn bg-secondary-custom link-hover-custom">Acceder</button>
            </form>
            <a href="restablecer_clave.php" class="d-block mt-3 text-decoration-none text-color-custom">¿Has olvidado tu contraseña?</a>
