                        ...
                        <div class="col-md-4 d-flex justify-content-center">
                            <div class="card" style="width: 17rem;">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <a href="/servidor/c_carrito.php?codigo=<?= $producto["codigo"] ?>&nombre=<?= $producto["nombre"] ?>&imagen=<?= $producto["imagen"] ?>&precio=<?= $producto["precio"] ?>&categoria=<?= $producto["categoria"] ?>" class="btn btn-outline-warning text-dark">Añadir al carrito</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
